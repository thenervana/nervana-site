...
export default function Home() {
  ...
  useEffect(() => {
    ...
    // Header background on scroll and mobile menu auto-close
    const handleScroll = () => {
  ...
  return (
    <>
            ...
            {isMobileMenuOpen && (
              <div className={styles.mobileMenuOverlay}>
                <nav className={styles.mobileMenuNav}>
                  ...
                  <Link href="#work" onClick={closeMobileMenu}>Work</Link>
                  <Link href="#framework" onClick={closeMobileMenu}>Framework</Link>
                  <Link href="#success" onClick={closeMobileMenu}>Success</Link>
                  <Link
                    href="https://calendly.com/jay-thenervana/call"
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`${styles.btn} ${styles.btnPrimaryMobile}`}
        ...
        <div className={styles.bannerOverlay}>
          <div className={styles.bannerTextBlock}>
            <div className={styles.bannerText}>
              <span className={styles.bannerTextLine1}>You just need to</span>
              <span className={styles.bannerTextLine2}>
      ...
      <section id="about" className={`${styles.section} ${styles.container} ${styles.animate}`}>
        ...
        <div className={styles.aboutContent}>
          <p className={styles.aboutText}>
            We help growth-stage founders turn their personal brand into a lead-gen machine - without lifting a finger.
          </p>
          <p className={styles.aboutText}>
            With our AI-led Trust Magnet Framework, we build and run a founder-led Personal Brand that makes the right audience follow, trust, and buy.
          </p>
        </div>
      </section>
      
      {/* Chat UI Section */}
      <section className={styles.chatLetterSection}>
        <div className={styles.chatContainer}>
          <div className={styles.chatHeader}>Chat with our Founder</div>
          <div className={styles.chatCardBg}>
      ...
      <div className={styles.ctaPrompt}>
        <div className={styles.ctaPromptInner}>
      ...
      <main id="main-content">
        ...
        <section id="success" className={`${styles.section} ${styles.container} ${styles.animate}`}>
          ...
          <div className={styles.gallerySection}>
            ...
            <p className={`${styles.container} ${styles.animate} ${styles.galleryDescription}`}>
        ...
        <div className={styles.bigFooterContainer}>
            ...
            <div className={styles.footerSocials}>
              <a href="https://twitter.com/gogadjeh/" target="_blank" rel="noopener" aria-label="X / Twitter">
                <svg width="22" height="22" fill="currentColor" aria-hidden="true">
                  <path d="M22 3.01l-7.43 9.16L21.89 21h-3.16l-5.22-6.41L6.01 21H0l7.64-9.43L.36 3h3.22l4.83 5.94L15.19 3H22zm-4.8 15.41h1.76L4.09 4.43H2.25l14.95 14.42z"></path>
                </svg>
              </a>
              <a href="https://linkedin.com/company/thenervana/" target="_blank" rel="noopener" aria-label="LinkedIn">
                <svg width="22" height="22" fill="currentColor" aria-hidden="true">
                  <path d="M20.447 20.452H16.89V15.413s.029-1.692-2.031-1.692c-2.058 0-2.371 1.834-2.371 1.834v4.897h-3.557V9.313h3.413v1.527h.049a3.557 3.557 0 013.197-1.757c3.417 0 4.049 2.25 4.049 5.174v6.195zM5.337 7.433a2.066 2.066 0 11-.002-4.132 2.066 2.066 0 01.002 4.132zM7.118 20.452H3.556V9.313h3.562v11.139zM22.225 0H1.771C.792 0 0 .771 0 1.729v20.542C0 21.228.792 22 1.771 22h20.451C21.2 22 22 21.229 22 20.271V1.729C22 .772 21.2 0 20.225 0h.001z"></path>
                </svg>
              </a>
              <a href="https://instagram.com/nervana.co/" target="_blank" rel="noopener" aria-label="Instagram">
                <svg width="22" height="22" fill="currentColor" aria-hidden="true">
                  <path d="M16.98 2H5.02A3.019 3.019 0 002 5.02v11.96A3.019 3.019 0 005.02 20h11.96A3.019 3.019 0 0020 16.98V5.02A3.019 3.019 0 0016.98 2zm1.248 14.98a1.25 1.25 0 01-1.248 1.248H5.02A1.25 1.25 0 013.772 16.98V5.02A1.25 1.25 0 015.02 3.772h11.96A1.25 1.25 0 0119.228 5.02v11.96zM11 6.835a4.165 4.165 0 100 8.33 4.165 4.165 0 000-8.33zm0 6.835a2.67 2.67 0 110-5.34 2.67 2.67 0 010 5.34zm5.2-6.97a1 1 0 11-2.001-.001A1 1 0 0116.2 6.7z"></path>
                </svg>
              </a>
            </div>
          </div>
          ...
          <div className={styles.footerCol}>
            ...
            <ul className={styles.footerList}>
              ...
              <li><Link href="https://linkedin.com/company/thenervana/">Careers</Link></li>
              <li>Blog</li>
              <li><Link href="#success">Case Studies</Link></li>
            </ul>
          </div>
          ...
          <div className={styles.footerCol}>
            ...
            <div className={styles.footerContactList}>
              <div className={styles.footerContactItem}>
                ...
                <a href="mailto:hello@thenervana.com">
            ...
            <div className={styles.footerNewsletter}>
              ...
              <form onSubmit={handleNewsletterSubmit} className={styles.footerNewsletterForm}>
                <input
                  type="email"
              ...
              {newsletterStatus && (
                <div className={styles.footerSuccessMsg}>
                  {newsletterStatus}
                </div>
              )}
            </div>
